...
export default function DangerButton({
    ...
    performance.mark("DangerButtonStartRender");

    useEffect(() => {
        performance.mark("DangerButtonEndRender");

        const measure = performance.measure(
            "DangerButtonMeasureRender",
            "DangerButtonStartRender",
            "DangerButtonEndRender"
        );
        console.log(
            `Total time for DangerButton render: ${measure.duration} ms, component complexity: 1`
        );
    }, []);
    return (
        <button
